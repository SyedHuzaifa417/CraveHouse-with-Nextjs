...
const Community: React.FC = () => {
  return (
    <main className="min-h-screen  p-6">
      ...
      <section className="flex flex-col md:flex-row gap-8 md:gap-12 mx-auto my-16 md:my-24 w-[95%] md:w-[90%] max-w-[75rem] justify-between">
        <nav className="flex space-x-4 overflow-x-auto lg:ml-44 bg-gray-700 shadow-lg shadow-stone-600 px-6 py-3 rounded-full">
        ...
        <select className="bg-gray-600 text-white rounded-full shadow-lg p-2 w-max hover:shadow-stone-600">
      ...
      <div className="flex flex-col lg:flex-row gap-16 mx-auto my-24 w-full max-w-[75rem]">
        ...
        <div className="w-full lg:w-1/4">
          <div className="sticky top-6">
            <div className=" flex items-center  w-full p-2 mb-4 rounded-xl bg-gray-700 text-white">
              <input
                type="text"
